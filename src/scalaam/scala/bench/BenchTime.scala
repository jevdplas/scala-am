...
object BenchTime {
    ...
    val regAAM  = new ConcurrentAAM[SchemeExp, address.A, lattice.L, timestamp.T, tid.threadID](StoreType.DeltaStore, sem, tid.Alloc())
    val modAtom = new ModAtom[SchemeExp, address.A, lattice.L, timestamp.T, tid.threadID](StoreType.DeltaStore, sem, tid.Alloc())
    ...
    val incCach = new IncAtomWCaching[SchemeExp, address.A, lattice.L, timestamp.T, tid.threadID](StoreType.DeltaStore, sem, tid.Alloc())
    
    val configurations: List[Configuration] = /* List(("incOPT", incOPT)) */ List(("modAtom", modAtom), ("incAtom", incAtom), ("incCach", incCach))
